...
class Service {
  ...
  Service(this.id, this.nombre, this.imageUrl, this.recomended);

  static final services = [
    Service(1, 'Evento de la semana en Altomayo',
        'assets/images/evento-ejemplo.jpg', true),
    Service(2, 'Evento en ciudad de  Madre de Dios',
        'assets/images/evento-ejemplo2.jpg', true),
    Service(3, 'Evento de la semana en Altomayo',
        'assets/images/evento-ejemplo.jpg', true),
    Service(4, 'Evento en ciudad de Madre de Dios',
        'assets/images/evento-ejemplo2.jpg', false),
    Service(3, 'Evento de la semana en Altomayo',
        'assets/images/evento-ejemplo.jpg', false),
    Service(4, 'Evento en ciudad de Madre de Dios',
        'assets/images/evento-ejemplo2.jpg', false),
  ];
}
